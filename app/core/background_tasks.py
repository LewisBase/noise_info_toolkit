...
class AudioProcessingTaskManager:
    ...
    def set_results_storage(self, storage: List):
        """Set storage for processing results"""
    ...
    async def _process_audio_file(self, file_path: str):
        ...
        try:
            ...
            # Store results if storage is set
            if self.results_storage is not None:
                ...
                serialized_results = {
                    ...
                    "frequency_spl": frequency_spl_dict,
                    "frequency_kurtosis": frequency_kurtosis_dict
                }
                
                self.results_storage.append(serialized_results)
